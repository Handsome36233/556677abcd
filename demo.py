...
H, W, _ = image.shape
boxes, classes, scores = detect(image, detect_session, anchors, size=size)
for box, c in zip(boxes, classes):
    ...
    # cv2.putText(image, label2className[c], (xmin, ymin - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
